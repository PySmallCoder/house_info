...
if __name__ =="__main__":
    ...
    start_urls = ["https://cd.xzl.anjuke.com/shou/p%d/" % d for d in range(1,90)]
    for url in start_urls:
        ...
        for url in urls:
            ...
            try:
                ...
                #标题
                communityInfo['title'] = ''.join(response.xpath('//h1[@class="tit-name"]/text()')[0].split())
                #总价
                ...
                #楼盘名
                communityInfo['house_name'] = response.xpath('//div[@id="fy_info"]/ul[1]/li[4]/span[2]/a/text()')[0]
                #地址
...
with open("d://房产//成都写字楼出售信息.json","w",encoding = "utf-8") as f:
