...
if __name__ =="__main__":
    ...
    start_urls = ["https://cq.sp.anjuke.com/shou/p%d/" % d for d in range(1,90)]
    for url in start_urls:
        ...
        for url in urls:
            ...
            try:
                ...
                #房源描述
                communityInfo['describe'] = ''.join(response.xpath('//div[@class="desc-con"]//text()'))
                #链接
...
with open("d://房产//商铺出售信息.json","w",encoding = "utf-8") as f:
